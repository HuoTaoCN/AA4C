...
| 能力 | 说明 | 状态 |
|------|------|------|
| **AA Send** | 局域网设备发现 + 点对点加密传输，支持文件/文件夹/大文件 | ✅ V0.1 已发布 |
| **AA Sync** | 多设备文件夹同步，增量同步、冲突处理、版本管理 | ✅ V0.2 已发布 |
| **AA Share** | 指定好友 / 家庭 / 团队设备之间的分享（非社区）；远程连接（打洞/中继/自建服务器） | ✅ V0.3 已发布 |
| **AA Download** | 统一下载中心：HTTP / HTTPS / FTP / BT / Magnet | ✅ V0.4 已发布 |
| **AA AI** | 规则式自动归档、AI 分类/标签建议、本地知识库问答（llama.cpp，零云端） | ✅ V0.5 已实现 |
