...
> 设计详见 [ARCHIVE_DESIGN.md](ARCHIVE_DESIGN.md)（v1 定稿，关键外部事实已真机实证）；实现计划见 [V0.5_IMPLEMENTATION_PLAN.md](V0.5_IMPLEMENTATION_PLAN.md)。**里程碑 AI1–AI5 全部已实现**。V0.5 仅桌面三平台，不含 Android。
