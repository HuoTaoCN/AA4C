...
## 四、下一步：AI2.0 前置实证已完成，从 AI2.1（`aa4c-engine` 重构）继续
...
**AI2.0–AI2.4 全部已完成并提交推送**（完整细节、真机踩坑记录见 ARCHIVE_DESIGN.md §3.1/§3.6，这里只留摘要）：
- **AI2.1** `aa4c-engine` 重构：sidecar 设施平移出 `aa4c-download`，纯机械重构，既有测试零修改通过。
